...
if __name__ == '__main__':
    ...
    print("create yelb")
    deploymentRes = client.ApplyDeployment(
        K8sGWRequest(fileName="yaml/redis-server-deployment.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(deploymentRes)
    serviceRes = client.ApplyService(
        K8sGWRequest(fileName="yaml/redis-server-service.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(serviceRes)
    deploymentRes = client.ApplyDeployment(
        K8sGWRequest(fileName="yaml/yelb-appserver-deployment.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(deploymentRes)
    serviceRes = client.ApplyService(
        K8sGWRequest(fileName="yaml/yelb-appserver-service.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(serviceRes)
    deploymentRes = client.ApplyDeployment(
        K8sGWRequest(fileName="yaml/yelb-db-deployment.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(deploymentRes)
    serviceRes = client.ApplyService(
        K8sGWRequest(fileName="yaml/yelb-db-service.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(serviceRes)
    deploymentRes = client.ApplyDeployment(
        K8sGWRequest(fileName="yaml/yelb-ui-deployment.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(deploymentRes)
    serviceRes = client.ApplyService(
        K8sGWRequest(fileName="yaml/yelb-ui-service.yaml", namespace="yelb", client_host=ho, client_port=po,
                     client_token=to))
    print(serviceRes)
